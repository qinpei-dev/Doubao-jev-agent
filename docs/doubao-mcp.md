...
6. Save the connector and check that the `jev_decide`, `agent_run`, `list_skills`, `controlled_agent_run`, and `approve_action` tools appear. The controlled tools were added in v0.3.0; the earlier client validation covered the first three tools.
